...
Tracing is currently wired at: backend/app/config.py, backend/app/main.py,
backend/chains/llm_provider.py, backend/chains/pipeline.py,
backend/prism/client.py, backend/.env.example
